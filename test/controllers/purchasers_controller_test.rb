...
class PurchasersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create purchaser" do
    assert_difference("Purchaser.count") do
      post purchasers_url, params: { purchaser: { email: @purchaser.email, first_name: @purchaser.first_name, last_name: @purchaser.last_name, phone: @purchaser.phone } }
    end
  ...
  test "should update purchaser" do
    patch purchaser_url(@purchaser), params: { purchaser: { email: @purchaser.email, first_name: @purchaser.first_name, last_name: @purchaser.last_name, phone: @purchaser.phone } }
